...
#define DEF_WLAN_2G_SSID	BOARD_PID "W"
#define DEF_WLAN_5G_SSID	BOARD_PID "W_5G"
#define DEF_WLAN_2G_GSSID	BOARD_PID "W_GUEST"
#define DEF_WLAN_5G_GSSID	BOARD_PID "W_GUEST_5G"
